...
-- ---------------------------------------------------------------------------
-- File tree. Old vimrc used NERDTreeTabsToggle on <leader>d. The tree backend
-- is neo-tree (editor.neo-tree extra; see plugins/neo-tree.lua for why, over
-- the Snacks explorer). Rather than hardcode :Neotree, remap to LazyVim's
-- explorer toggle (<leader>e), which the neo-tree extra owns. Keep <leader>d,
-- add <leader>v alias.
-- ---------------------------------------------------------------------------
